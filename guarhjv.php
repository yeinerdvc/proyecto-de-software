...
<script src="https://kit.fontawesome.com/d998ddc180.js" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" type="text/css" href="css/ghojas.css">
...
<body>
    ...
    <div id="div1" class="container">
        <div class="bmenu">
            <form action="subirhjv.php" method="POST" enctype="multipart/form-data">
            <label for="file">Subir Hoja de Vida</label><br>
